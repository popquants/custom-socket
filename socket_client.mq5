...
//|                                                Socket_client.mq5 |
//|                                                      tong_exness |
//|                                      tanapat.kamsaiin@exness.com |
//+------------------------------------------------------------------+
#property copyright "tong_exness"
#property link      "tanapat.kamsaiin@exness.com"
...
//}
{
   ...
   string str_prices = " | Bid: " + DoubleToString(bid_price) + " | Ask: " + DoubleToString(ask_price);
   
   Socket_Send(My_Socket_Handle, str_prices); 
}
